...
class TaskAnalysis(BaseModel):
    ...
    rationale: str = ""
    # Task-specific instruction text per node role, generated by the analyzer
    # when confidence is sufficient.  Keys are NodeType value strings
    # (e.g. "direct", "solve", "plan", "verify", "critique").  Templates.py
    # uses these in place of the generic placeholder strings so that every seed
    # starts with meaningful, task-grounded prompt text rather than fill-in-the-
    # blank defaults.  Absent or empty entries fall back to generic text.
